...
public class AuthenticationController {
    ...
    ApiResponse<AuthenticationResponse> exchangeOAuthCode(@RequestBody ExchangeCodeRequest request) {
        var result = authenticationService.exchangeCode(request.getCode());
        return ApiResponse.<AuthenticationResponse>builder().result(result).build();
    }
}
