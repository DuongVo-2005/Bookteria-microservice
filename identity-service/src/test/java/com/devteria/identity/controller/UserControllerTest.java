...
// Trước đây test file này KHÔNG compile được (UserResponse builder gọi .firstName()/.lastName()/
// .dob() không còn tồn tại) VÀ post nhầm endpoint "/users" (route thật là "/users/registration",
// xem UserController — "/users" bare path giờ là GET list, admin-only). Viết lại đúng contract hiện tại.
@Slf4j
@SpringBootTest
