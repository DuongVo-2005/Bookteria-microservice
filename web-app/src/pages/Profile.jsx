...
import { ShelfPrivacySettings } from "../components/book/ShelfPrivacySettings";
...
export default function Profile() {
  ...
  const handleUpdate = async () => {
    try {
      // Prepare the data for update — LUÔN gửi kèm username hiện tại dù
      // không có ô nhập riêng cho nó: BE (PUT /profile/users/my-profile)
      // ghi đè toàn bộ field theo đúng body gửi lên, không có field nào thì
      // set thành rỗng — thiếu username ở đây sẽ xoá vĩnh viễn tên hiển thị
      // của user (ảnh hưởng cả người khác nhìn vào, vd. danh sách bạn bè).
      const profileData = {
      ...
      {userDetails ? (
        ...
        >
          ...
          >
            ...
            >
              Welcome back to Bookteria, {userDetails.username} !
            </Typography>
            <Box
              sx={{
                display: "flex",
