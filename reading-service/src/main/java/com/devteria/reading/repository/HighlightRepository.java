...
public interface HighlightRepository extends MongoRepository<Highlight, String> {
    List<Highlight> findByUserIdAndBookId(String userId, String bookId);

    Optional<Highlight> findByIdAndUserId(String id, String userId);

    void deleteAllByBookId(String bookId);

    // idea-spec BA v2 §3.1 Offline Sync Batch: dedupe theo idempotency key client tự sinh.
    Optional<Highlight> findByUserIdAndClientId(String userId, String clientId);
}
